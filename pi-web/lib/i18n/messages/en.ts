...
export const enLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "channels.wechatDesc": "Chat with your Personal Agent from WeChat. Private messages enter the unified session after connecting.",
    "channels.gatewayDisabled": "Personal Gateway not enabled (requires PERSONAL_GATEWAY_ENABLED=1).",
    "channels.connected": "Connected",
    "channels.connecting": "Connecting…",
    "channels.notConnected": "Not connected",
    "channels.authExpired": "Expired, scan again",
    "channels.disconnect": "Disconnect",
    "channels.connect": "Connect WeChat",
    "channels.scanTitle": "Scan with WeChat to connect",
    "channels.waitingScan": "Waiting for scan…",
    "channels.connectSucceeded": "WeChat is connected.",
    "channels.connectExpired": "QR code expired. Refresh it.",
    "channels.connectFailed": "Connection failed. Try again.",
    "channels.connectCancelled": "Connection cancelled.",
    "channels.verifyRequired": "Enter the number shown in WeChat to continue.",
    "channels.verifyMismatch": "Code did not match. Enter the new number shown in WeChat.",
    "channels.verifyPlaceholder": "Code",
    "channels.verifySubmit": "Verify",
    "channels.refreshQr": "Refresh QR",
    "channels.cancel": "Cancel",
    "channels.allowFrom": "Allowed contacts",
    "channels.allowFromHint": "Only allowed contacts can chat; empty = allow all",
    "channels.progressHint": "Progress hint",
    "channels.progressHintDesc": "Show \"typing\" and progress hints in WeChat while the agent works",
    "channels.toolHints": "Tool hints",
    "channels.toolHintsDesc": "Show \"using tool…\" when the agent calls tools (read file / run command)",
    "channels.advanced": "Advanced",
    "channels.replyProgress": "Structured progress",
    "channels.replyProgressDesc": "Send status messages when tools start / complete / fail",
    "channels.replyProgressMax": "Structured progress limit",
    "channels.replyProgressMaxDesc": "Max messages per conversation",
    "channels.blockStreaming": "Stream reply in blocks",
    "channels.blockStreamingDesc": "Send long replies in blocks while generating",
    "channels.blockMinChars": "Min block characters",
    "channels.blockMinCharsDesc": "Blocks trigger at this length (200-1800)",
    "channels.blockMaxMessages": "Max block messages",
    "channels.blockMaxMessagesDesc": "Max intermediate blocks (1-4)",
    ...
    "sidebar.chooseFolder": "Choose a project folder",
    ...
    "sidebar.noProjectSessions": "No project sessions",
    ...
    "sidebar.removeProjectConfirm": "Remove {name} from Pi? Local files will not be deleted.",
    "sidebar.removeProjectInUse": "This project still has linked sessions and cannot be removed yet.",
