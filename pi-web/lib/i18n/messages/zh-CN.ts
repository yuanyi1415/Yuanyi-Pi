...
export const zhCNLocale: LocalePlugin = {
  ...
  messages: {
    ...
    "common.settings": "设置",
    "channels.wechat": "微信",
    "channels.wechatDesc": "在微信中与 Personal Agent 对话。连接后，微信私聊消息将进入统一会话。",
    "channels.gatewayDisabled": "Personal Gateway 未启用（需 PERSONAL_GATEWAY_ENABLED=1）。",
    "channels.connected": "已连接",
    "channels.connecting": "连接中…",
    "channels.notConnected": "未连接",
    "channels.authExpired": "已失效，请重新扫码",
    "channels.disconnect": "断开连接",
    "channels.connect": "连接微信",
    "channels.scanTitle": "用手机微信扫码连接",
    "channels.waitingScan": "等待扫码…",
    "channels.connectSucceeded": "微信已连接。",
    "channels.connectExpired": "二维码已过期，请刷新。",
    "channels.connectFailed": "连接失败，请重试。",
    "channels.connectCancelled": "已取消连接。",
    "channels.verifyRequired": "输入手机微信中显示的数字以继续。",
    "channels.verifyMismatch": "验证码不匹配，请输入微信显示的新数字。",
    "channels.verifyPlaceholder": "验证码",
    "channels.verifySubmit": "验证",
    "channels.refreshQr": "刷新二维码",
    "channels.cancel": "取消",
    "channels.allowFrom": "授权联系人",
    "channels.allowFromHint": "仅指定联系人可对话，留空 = 全部接受",
    "channels.progressHint": "处理中提示",
    "channels.progressHintDesc": "Agent 处理消息时微信显示\"正在输入\"与进度提示",
    "channels.toolHints": "工具提示",
    "channels.toolHintsDesc": "Agent 调用工具（读文件/执行命令）时显示\"正在使用工具…\"",
    "channels.advanced": "高级设置",
    "channels.replyProgress": "结构化进度",
    "channels.replyProgressDesc": "工具开始 / 完成 / 失败时发送状态消息",
    "channels.replyProgressMax": "结构化进度上限",
    "channels.replyProgressMaxDesc": "单次对话最多发送条数",
    "channels.blockStreaming": "分块发送回复",
    "channels.blockStreamingDesc": "长回复生成中分段送达，无需等全部完成",
    "channels.blockMinChars": "最小分块字符数",
    "channels.blockMinCharsDesc": "达到该长度才触发分块（200-1800）",
    "channels.blockMaxMessages": "分块消息上限",
    "channels.blockMaxMessagesDesc": "中途分块最多条数（1-4）",
    "channels.saving": "保存中…",
    "channels.saved": "已保存。",
    ...
    "sidebar.newTopic": "新建话题",
    "sidebar.chooseFolder": "选择项目文件夹",
    "sidebar.refresh": "刷新",
    ...
    "sidebar.noProjectSessions": "无项目会话",
    "sidebar.topics": "话题",
    "sidebar.projects": "项目",
    ...
    "sidebar.removeProjectConfirm": "从 Pi 中移除“{name}”？本地文件夹不会被删除。",
    "sidebar.removeProjectInUse": "该项目仍有关联会话，暂不能移除。",
    "sidebar.delete": "删除",
